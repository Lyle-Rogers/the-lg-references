...
class AssistantForm extends Component {
  ...
  handleSubmit(e) {
    ...
    Axios.post(
      "https://www.lebarongaleana-api.com/api/YOI_Assistant/",
      {
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="row">
              <p>
                ...
                take your time to read and fill outthis application thoughtfully
            ...
            <div className="row">
              <div className="quoteBox">
                ...
                <p>
                  ...
                  greatexample to the youth. So remember to continue being that
                  even afterthe retreat is over.
                </p>
              </div>
            </div>
            <div className="row">
              <div className="agreement">
                ...
                <div className="date">
                  ...
                  <div className="moment">5/12/2021</div>
                </div>
              </div>
            </div>
            <div className="row">

...
export default class AdminUsers extends Component {
  ...
  handleSearch(e) {
    let url = "https://www.lebarongaleana-api.com/api/admin/users/?search=" + e.target.value;
    this.getUsers(url);
  }
  ...
  handleDeleteUser() {
    ...
    Axios.post(
      "https://www.lebarongaleana-api.com/api/admin/users/",
      {
        post_type: "DELETE",
        id: user.id,
      },
      ...
      if (response.data.Success) {
        ...
        this.getUsers("https://www.lebarongaleana-api.com/api/admin/users/");
                ...
                {this.state.deleteProcessing ? (
                  <div>
                    {this.state.deleteProcessingFinished ? (
                      <div className="successful">User Successfully Deleted</div>
                    ) : (
                      <Spinner />
                    )}
                  </div>

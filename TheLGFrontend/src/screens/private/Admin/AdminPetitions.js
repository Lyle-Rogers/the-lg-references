...
export default class AdminPetitions extends Component {
  ...
  handleSearch(e) {
    let url = "https://www.lebarongaleana-api.com/api/admin/get_petition_entries/?search=" + e.target.value;
  ...
  componentDidMount() {
    this.getPetitionEntries("https://www.lebarongaleana-api.com/api/admin/get_petition_entries/");
  }

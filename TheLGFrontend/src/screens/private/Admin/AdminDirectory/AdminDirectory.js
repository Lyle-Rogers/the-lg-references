...
class AdminDirectory extends Component {
  ...
  createBusinessPage() {
    Axios.post(
      "https://www.lebarongaleana-api.com/api/businessPageAdmin/",
      {
  ...
  handleSubmit(event) {
    Axios.put(
      "https://www.lebarongaleana-api.com/api/adminDirectory/",
      {
    ...
    if (item) {
      if (confirm("Are you sure?") == true) {
        if (this.state.activeItem) {
          Axios.delete("https://www.lebarongaleana-api.com/api/adminDirectory/", {
            headers: {
              Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
            },
            data: {

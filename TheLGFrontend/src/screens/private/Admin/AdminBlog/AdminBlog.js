...
export default class AdminBlog extends Component {
  ...
  handleSearch(e) {
    let url = "https://www.lebarongaleana-api.com/api/blog/?search=" + e.target.value;
    this.getBlogPosts(url);
  }

  handleDelete() {
    Axios.delete("https://www.lebarongaleana-api.com/api/blog/", {
      headers: {
      ...
      .then((res) => {
        if (res.data.status === "Success") {
          ...
          this.getBlogPosts("https://www.lebarongaleana-api.com/api/blog/");
        }
      })
      .catch((err) => {
        console.log(err);
      ...
      <div className={this.props.className}>
        ...
        >
          <div className="modal-header">
            ...
            {this.state.saved == true ? <div className="saved">Saved</div> : <div className="saving">Saving!</div>}

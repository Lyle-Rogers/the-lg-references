...
export default class Classifieds extends Component {
  ...
  handleFilter() {
    ...
    Axios.get(
      `https://www.lebarongaleana-api.com/api/listing/items/?categories=${categories}`,
      {
        headers: {
          Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
        },
  ...
  handleSearch(e) {
    Axios.get(
      `https://www.lebarongaleana-api.com/api/listing/items/?search=${e.target.value}`,
      {
        headers: {
          Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
        },
  ...
  componentDidMount() {
    ...
    this.getItems("https://www.lebarongaleana-api.com/api/listing/items/");
  }

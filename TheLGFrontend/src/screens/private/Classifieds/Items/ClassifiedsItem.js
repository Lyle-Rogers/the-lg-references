...
export default class ClassifiedsItem extends Component {
  ...
  getItem() {
    ...
    Axios.get(`https://www.lebarongaleana-api.com/api/listing/items/?itemId=${id}`, {
      headers: {
    ...
    Axios.get(`https://www.lebarongaleana-api.com/api/listing/favorites/?listingId=${id}`, {
      headers: {
        Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
      },
    })
  ...
  favorite() {
    ...
    if (this.state.favorited) {
      Axios.delete(`https://www.lebarongaleana-api.com/api/listing/favorites/?listingId=${id}`, {
        headers: {
          Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
        },
      })

...
import { faTrash, faPen, faPlus, faEllipsisH, faSignOutAlt, faEdit } from "@fortawesome/free-solid-svg-icons";
...
class Groups extends Component {
  ...
  deleteText(messageId) {
    Axios.post(
      `https://www.lebarongaleana-api.com/api/group_messages/${this.state.groupData.id}`,
      {
        messageId: messageId,
        post_type: "delete",
      },
  ...
  leaveGroup() {
    Axios.post(
      `https://www.lebarongaleana-api.com/api/my_group/`,
      {
  ...
  getGroup() {
    Axios.get("https://www.lebarongaleana-api.com/api/my_group/", {
      headers: {
        Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
      },
    })
        ...
        <div className="groups-wrapper">
          ...
          <div className="groups">
              <div className={this.state.settings}>
                <button className="Gbtn-classM" onClick={() => {
                ...
                <button className="Gbtn-classM" onClick={() => { this.HandleSettingsClose(); this.groupParticipantsClosed(); }}>
                   <FontAwesomeIcon className="Gbtn-icon" icon={faSignOutAlt} />
                </button>
            <div className="upper">
              <div className="group">
                <div className="description">
                  <div className="desc-header">Description

                    {this.state.groupData.leader.id === this.props.user.id ? (
                      <button className="Gbtn-class" onClick={this.toggleEditDesc}>
                    ...
                    <div className="desc-body">
                      <textarea type="text" value={this.state.groupData.description} onChange={(e) => this.HandleEditDesc(e)} placeholder={this.state.groupData.description} />
                    </div>
                  }
                </div>
              </div>
              ...
              <div className={this.state.settingsParticipants}>
                <div className="groupParticipantsHeader">
                  ...
                  <div className="settings">
                    <button className="GroupButton" onClick={this.leaveGroup}>Leave Group</button>
                  </div>

...
import koslogorough from "../../../static/assets/koslogorough-inverted-transparent.png";

export default function () {
  return (
    <div className="homepage-container">
      <div className="logo-wrapper">
        <img className="logo" src={koslogorough} alt="kos logo" />
      </div>

      <div className="box-rising">
        <div className="wrapper">
          <h1 className="header">Welcome to KOS fitness 7.0</h1>
          <p>
        ...
        <div className="wrapper">
          <ul>
            ...
            <li>
              ...
              hurt or injured, please let me know ahead of time. If the
            ...
            <li>
              ...
              will not count. Use good judgement, don’t make me have to tell you
              what a workout is.
            </li>
          </ul>
          <h1 className="header">The entry fee is $206 USD.</h1>
        </div>
      </div>
      <div className="box-falling">
        <div className="wrapper">
          <h1 className="header">We have 3 different groups:</h1>
        </div>
      </div>
      <div className="box-rising">
        <div className="wrapper">
      ...
      <div className="box-rising">
        <div className="wrapper">
          <ul>
            ...
            <li>
              Most improved ( PM your before pic no later than Sunday 8/18 ).
            </li>
            <li>
              Most weight loss ( PM video of your weight on scale no later than
              Sunday 8/18 ). If you attended the last challenge, we will use
              your ending weight.
            </li>
